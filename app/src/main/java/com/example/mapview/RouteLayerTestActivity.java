                ...
                markLayer.setMarkIsClickListener(new MarkLayer.MarkIsClickListener() {
                    ...
                    public void markIsClick(int num) {
                        ...
                        List<Integer> routeList =
                                MapUtils.getShortestDistanceBetweenTwoPoints(marks.get(0), target, nodes, nodesContract);
        ...
        if (mapView.isMapLoadFinish()) {
            switch (item.getItemId()) {
                case R.id.route_layer_tsp:
                    ...
                    List<Integer> routeList = MapUtils.getBestPathBetweenPoints(list, nodes, nodesContract);
                    routeLayer.setNodeList(nodes);
                    routeLayer.setRouteList(routeList);
                    mapView.refresh();
                    break;
